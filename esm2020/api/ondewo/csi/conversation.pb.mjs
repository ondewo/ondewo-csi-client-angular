        ...
        while (_reader.nextField()) {
            ...
            switch (_reader.getFieldNumber()) {
                ...
                case 2:
                    ...
                    _reader.readMessage(_instance.synthetizeResponse, ondewoT2s012.SynthesizeResponse.deserializeBinaryFromReader);
                    break;
                case 3:
    ...
    toObject() {
        return {
            detectIntentResponse: this.detectIntentResponse
                ...
                : undefined,
            synthetizeResponse: this.synthetizeResponse
                ? this.synthetizeResponse.toObject()
                : undefined,
    ...
    options) {
        return {
            detectIntentResponse: this.detectIntentResponse
                ...
                : null,
            synthetizeResponse: this.synthetizeResponse
                ? this.synthetizeResponse.toProtobufJSON(options)
                : null,
...
export class SipTrigger {
    ...
    constructor(_value) {
        ...
        this.content = _value.content
            ? new googleProtobuf003.Struct(_value.content)
            : undefined;
...
export class CheckUpstreamHealthResponse {
    ...
    constructor(_value) {
        ...
        this.s2tStatus = _value.s2tStatus
            ? new googleRpc004.Status(_value.s2tStatus)
            : undefined;
        this.nluStatus = _value.nluStatus
            ? new googleRpc004.Status(_value.nluStatus)
            : undefined;
        this.t2sStatus = _value.t2sStatus
            ? new googleRpc004.Status(_value.t2sStatus)
            : undefined;
...
export class CondtionValueUnion {
    ...
    constructor(_value) {
        ...
        this.datetimeValue = _value.datetimeValue
            ? new googleProtobuf010.Timestamp(_value.datetimeValue)
            : undefined;
    ...
    options) {
        return {
            ...
            floatValue: this.floatValue === null || this.floatValue === undefined
                ...
                : this.floatValue,
            datetimeValue: this.datetimeValue
                ? this.datetimeValue.toProtobufJSON(options)
                : null
        };
    }
}
...
export class ControlMessageServiceParameters {
    ...
    constructor(_value) {
        ...
        this.context = _value.context
            ? new ondewoNlu006.Context(_value.context)
            : undefined;
        this.sessionId = _value.sessionId;
